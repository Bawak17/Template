...
register_sidebar( array(
	...
	'id' => 'htopinfo',
	'description' => __( 'Header Top Infromation', 'twentyten' ),
...
register_sidebar( array(
	'name' => __( 'Banner Top Information', 'twentyten' ),
	'id' => 'bnr_info1',
	'description' => __( 'Banner Widget', 'twentyten' ),
	'before_widget' => '<div class="widget-container %2$s">',
	'after_widget' => '</div>',
	'before_title' => '',
	'after_title' => '',
...
register_sidebar( array(
	...
	'id' => 'bnr_info2',
	'description' => __( 'Banner Slogan and Text', 'twentyten' ),
	'before_widget' => '<div class="widget-container %2$s">',
	'after_widget' => '</div>',
	'before_title' => '',
	'after_title' => '',
...
register_sidebar( array(
	...
	'id' => 'foot1',
	'description' => __( 'Footer Widget', 'twentyten' ),
	'before_widget' => '<div class="widget-container %2$s">',
	'after_widget' => '</div>',
	'before_title' => '',
	'after_title' => '',
...
register_sidebar( array(
	'name' => __( 'Socialmedia Links', 'twentyten' ),
	'id' => 'foot2',
	'description' => __( 'Footer Widget', 'twentyten' ),
	'before_widget' => '<div class="widget-container %2$s">',
	'after_widget' => '</div>',
...
register_sidebar( array(
	'name' => __( 'Service Areas Covered', 'twentyten' ),
	'id' => 'foot3',
	'description' => __( 'Footer Widget', 'twentyten' ),
	'before_widget' => '<div class="widget-container %2$s">',
	'after_widget' => '</div>',
...
/* Start of Code for search result pagination*/
...
// for display any per page in products
...
function add_loginout_link( $items, $args ) {
   ...
   elseif (!is_user_logged_in() && $args->theme_location == 'primary') {
       $items .= '<li><a href="' . get_permalink( woocommerce_get_page_id( 'myaccount' ) ) . '">Sign In</a></li>';
   }
   return $items;

}
/*End Code for search result here*/
